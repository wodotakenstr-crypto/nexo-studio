...
function replyTo(text) {
  ...
  if (question.includes('proyecto') || question.includes('venta')) return 'Tenemos Size Convert y Ciber Control, ademas de soluciones a medida. Puedes ver los detalles en la seccion Proyectos.';
  ...
  if (question.includes('size') || question.includes('talla') || question.includes('estampado')) return 'Size Convert adapta tallas y medidas de modelos para preparar uniformes y estampados antes de imprimirlos.';
